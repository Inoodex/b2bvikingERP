# 📘 Phase 3 (Steps 3.1 – 3.5) Enterprise User & Manual Testing Guide

এই ডকুমেন্টটিতে **B2B Viking ERP**-এর Sales Module (Steps 3.1 থেকে 3.5)-এর প্রতিটি ফিচারের **ব্যবসায়িক উদ্দেশ্য (Business Purpose)**, **কখন ও কেন ব্যবহার করবেন (Real-World Use Cases)** এবং **ধাপে ধাপে ম্যানুয়াল টেস্ট করার নিয়ম** সম্পূর্ণ বিস্তারিতভাবে উপস্থাপন করা হলো।
...
1. নেভিগেশন বার থেকে **Orders ➔ Gift Cards Engine** পেজে যান:  
...
💡 **উপসংহার:** এই ডকুমেন্টটি পড়ে ইউজার বা ক্লায়েন্ট যেমন বুঝতে পারবেন **কেন এই ফিচারগুলো প্রয়োজন**, তেমনই সহজে প্রতিটি ফিচার টেস্ট সম্পন্ন করতে পারবেন!
