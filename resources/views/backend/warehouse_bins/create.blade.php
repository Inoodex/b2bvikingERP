                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" 
                                        placeholder="e.g. Rack A - Shelf 2" value="{{ old('name') }}" required>
                                    @error('name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>Barcode</label>
                                    <input type="text" class="form-control bg-light" value="Auto-Generated on Save (BIN-OUTLET-ZONE-BIN)" readonly>
                                </div>
                            </div>

                            <div class="text-right mt-3">
                                <a href="{{ route('admin.warehouse-bins.index') }}" class="btn btn-secondary mr-2">Cancel</a>
                                <button type="submit" class="btn btn-primary px-4">Create Bin</button>
                            </div>
                        </form>
                    </div>
                </div>
