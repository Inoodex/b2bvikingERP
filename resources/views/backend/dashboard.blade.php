...
@section('content')
    <section class="section">
        ...
        <div class="executive-header-bar d-flex justify-content-between align-items-center flex-wrap" style="gap: 16px;">
            <div>
                <h1 class="font-weight-bold text-dark mb-1"
                    style="font-size: 24px; letter-spacing: -0.025em; font-family: 'Plus Jakarta Sans', -apple-system, BlinkMacSystemFont, sans-serif;">
                    Dashboard
                </h1>
                <p class="text-muted mb-0" style="font-size: 13px;">
                    Consolidated commercial revenue, liquidity position, inventory assets & catalog health across all
                    channels.
                </p>
            </div>
            ...
            <div class="d-flex align-items-center flex-wrap" style="gap: 12px;">
                ...
                <div class="d-inline-flex align-items-center p-1"
                    style="background: #f1f5f9; border-radius: 8px; border: 1px solid #e2e8f0;">
                ...
                <a href="{{ route('admin.sales-orders.create') }}"
                    class="btn font-weight-bold d-inline-flex align-items-center shadow-sm"
                ...
                <div>
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <span class="text-uppercase font-weight-bold"
                            style="font-size: 10.5px; letter-spacing: 0.06em; color: #64748b;">
                            Total Sales Revenue
                        </span>
                        <div class="d-flex align-items-center justify-content-center"
                            style="width: 32px; height: 32px; border-radius: 7px; background: #ecfdf5; color: #059669;">
                    ...
                    <h3 class="mb-0 font-weight-bold text-dark"
                        style="font-size: 21px; letter-spacing: -0.02em; font-family: 'Plus Jakarta Sans', sans-serif;">
                ...
                <div class="pt-2 mt-2" style="border-top: 1px solid #f1f5f9;">
                    <div class="d-flex justify-content-between align-items-center" style="font-size: 11px;">
                        <span class="text-muted" style="font-size: 10.5px;"
                            title="Operating Expenses & COGS: {!! formatWithCurrency($cogs) !!}">Net Profit: <strong
                                class="text-dark">kr.
                                {{ $grossProfit >= 1000000 ? number_format($grossProfit / 1000000, 2) . 'M' : number_format($grossProfit, 0) }}</strong></span>
                        <span class="badge font-weight-bold px-1.5 py-0.5"
                            style="font-size: 9.5px; background: #ecfdf5; color: #047857; border: 1px solid #a7f3d0; border-radius: 4px;">
            ...
            <div class="executive-kpi-card">
                ...
                <div>
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <div class="d-flex align-items-center justify-content-center"
                            style="width: 32px; height: 32px; border-radius: 7px; background: #eff6ff; color: #2563eb;">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
                                <path
                ...
                <div class="pt-2 mt-2" style="border-top: 1px solid #f1f5f9;">
                    <div class="d-flex justify-content-between align-items-center" style="font-size: 11px;">
                        ...
                        <span class="badge font-weight-bold px-1.5 py-0.5 text-muted border"
                            style="font-size: 9.5px; background: #f8fafc; border-radius: 4px;">
                            Asset 1040
                        </span>
                    </div>
                </div>
            ...
            <div class="executive-kpi-card">
                ...
                <div>
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <div class="d-flex align-items-center justify-content-center"
                            style="width: 32px; height: 32px; border-radius: 7px; background: #f5f3ff; color: #7c3aed;">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="pt-2 mt-2" style="border-top: 1px solid #f1f5f9;">
                    <div class="d-flex justify-content-between align-items-center flex-wrap"
                        style="font-size: 10.5px; gap: 4px;">
                        <a href="{{ route('admin.products.index') }}?status=1"
                            class="badge font-weight-bold px-2 py-0.5 text-decoration-none"
                            style="font-size: 9.5px; background: #ecfdf5; color: #047857; border: 1px solid #a7f3d0; border-radius: 4px;"
                            title="Active Live Catalog">
                            <i class="fas fa-check mr-1"></i>{{ number_format($totalActiveProducts) }} Active
                        </a>
                        <a href="{{ route('admin.products.index') }}?status=0"
                            class="badge font-weight-bold px-2 py-0.5 text-decoration-none"
                            style="font-size: 9.5px; background: #fffbeb; color: #b45309; border: 1px solid #fde68a; border-radius: 4px;"
                            title="Inactive / Draft SKUs">
            ...
            <div class="executive-kpi-card">
                ...
                <div>
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <div class="d-flex align-items-center justify-content-center"
                            style="width: 32px; height: 32px; border-radius: 7px; background: #fffbeb; color: #d97706;">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="executive-kpi-card">
                ...
                <div>
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <div class="d-flex align-items-center justify-content-center"
                            style="width: 32px; height: 32px; border-radius: 7px; background: #fef2f2; color: #dc2626;">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="card border-0 shadow-sm mb-4"
            style="border-radius: 12px; border: 1px solid #e2e8f0 !important; overflow: hidden; background: #ffffff;">
            <div class="row no-gutters">
                {{-- Velocity 1: Orders Pipeline --}}
                <div class="col-xl-3 col-md-6 col-12 p-3 border-right border-bottom border-xl-bottom-0 d-flex align-items-center justify-content-between"
                    style="border-color: #f1f5f9 !important;">
                    <div class="d-flex align-items-center" style="gap: 12px;">
                        <div class="d-flex align-items-center justify-content-center flex-shrink-0"
                            style="width: 36px; height: 36px; border-radius: 8px; background: #eff6ff; color: #2563eb;">
                        ...
                        <div>
                            <div class="font-weight-bold text-dark" style="font-size: 14px;">
                                {{ number_format($ordersInPipeline) }} Orders</div>
                            <small class="text-muted" style="font-size: 11px;">In Fulfillment Pipeline</small>
                        </div>
                    </div>
                    <a href="{{ route('admin.orders.index') }}"
                        class="btn btn-sm btn-light border py-1 px-2.5 font-weight-bold text-primary"
                ...
                <div class="col-xl-3 col-md-6 col-12 p-3 border-right border-bottom border-xl-bottom-0 d-flex align-items-center justify-content-between"
                    ...
                    <div class="d-flex align-items-center" style="gap: 12px;">
                        <div class="d-flex align-items-center justify-content-center flex-shrink-0"
                            style="width: 36px; height: 36px; border-radius: 8px; background: #fffbeb; color: #d97706;">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div>
                            <div class="font-weight-bold text-dark" style="font-size: 14px;">
                                {{ number_format($pendingApprovals) }} Pending</div>
                            <small class="text-muted" style="font-size: 11px;">Requisitions & Sign-Offs</small>
                        </div>
                    </div>
                    <a href="{{ route('admin.approvals.index') }}"
                        class="btn btn-sm btn-light border py-1 px-2.5 font-weight-bold text-warning"
                        style="font-size: 11px; border-radius: 6px;">
                        Approve
                    </a>
                </div>
                ...
                <div class="col-xl-3 col-md-6 col-12 p-3 border-right border-bottom border-md-bottom-0 d-flex align-items-center justify-content-between"
                    style="border-color: #f1f5f9 !important;">
                    <div class="d-flex align-items-center" style="gap: 12px;">
                        <div class="d-flex align-items-center justify-content-center flex-shrink-0"
                            style="width: 36px; height: 36px; border-radius: 8px; background: #fef2f2; color: #dc2626;">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div>
                            <div class="font-weight-bold text-dark" style="font-size: 14px;">
                                {{ number_format($lowStockCount) }} Low Stock</div>
                            <small class="text-muted" style="font-size: 11px;">Reorder Alerts</small>
                        </div>
                    </div>
                    <a href="{{ route('admin.products.index') }}"
                        class="btn btn-sm btn-light border py-1 px-2.5 font-weight-bold text-danger"
                        style="font-size: 11px; border-radius: 6px;">
                        Restock
                    </a>
                </div>
                ...
                <div class="col-xl-3 col-md-6 col-12 p-3 d-flex align-items-center justify-content-between"
                    style="border-color: #f1f5f9 !important;">
                    <div class="d-flex align-items-center" style="gap: 12px;">
                        <div class="d-flex align-items-center justify-content-center flex-shrink-0"
                            style="width: 36px; height: 36px; border-radius: 8px; background: #ecfdf5; color: #059669;">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div>
                            <div class="font-weight-bold text-dark" style="font-size: 14px;">
                                {{ number_format($activeOutlets) }} Active Outlets</div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-lg-8 col-12 mb-4 mb-lg-0">
                <div class="card h-100 border-0 shadow-sm"
                    style="border-radius: 12px; border: 1px solid #e2e8f0 !important; background: #ffffff;">
                    <div class="card-header bg-white d-flex flex-wrap justify-content-between align-items-center py-3 px-4"
                        style="border-bottom: 1px solid #f1f5f9; gap: 12px;">
                        <div>
                            <div class="d-flex align-items-center" style="gap: 8px;">
                                <span class="d-flex align-items-center justify-content-center"
                                    style="width: 28px; height: 28px; border-radius: 6px; background: #eff6ff; color: #2563eb;">
                                ...
                                <div>
                                    <h4 class="font-weight-bold text-dark mb-0" style="font-size: 15px;">Sales & Revenue
                                        Velocity</h4>
                                    <small class="text-muted">Peak: <strong
                                            class="text-dark">{{ $peakMonthLabel }}</strong> ({!! formatWithCurrency($peakMonthSales) !!})
                                        &bull; Run-Rate: <strong
                                            class="text-dark">{!! formatWithCurrency($avgMonthlySales) !!}/mo</strong></small>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex align-items-center" style="gap: 8px;">
                            {{-- Interactive Metric Switcher --}}
                            <div class="btn-group btn-group-sm p-0.5 bg-light border"
                                style="border-radius: 8px; border-color: #e2e8f0 !important;">
                                <button type="button" class="btn btn-sm font-weight-bold shadow-none"
                                    id="btnChartRevenue" onclick="switchExecutiveChart('revenue')"
                                    style="font-size: 11px; border-radius: 6px; padding: 3px 10px; background: #ffffff; color: #0f172a; border: 1px solid #cbd5e1;">
                                    Revenue (kr.)
                                </button>
                                <button type="button" class="btn btn-sm font-weight-bold shadow-none text-muted"
                                    id="btnChartOrders" onclick="switchExecutiveChart('orders')"
                                    style="font-size: 11px; border-radius: 6px; padding: 3px 10px; border: 1px solid transparent;">
                                    Order Volume
                                </button>
                            </div>
                            <span class="badge border font-weight-bold px-2 py-1 text-muted"
                                style="font-size: 10px; background: #f8fafc; border-radius: 6px;">
                                Live Analytics
                            </span>
                        </div>
                    </div>
                            ...
                            <div style="position: relative; width: 160px; height: 160px;">
                                ...
                                <div
                                    ...
                                    <div class="font-weight-bold text-dark" style="font-size: 13px; line-height: 1.1;">
                                        kr.
                                        {{ $totalCatSales >= 1000000 ? number_format($totalCatSales / 1000000, 2) . 'M' : number_format($totalCatSales / 1000, 0) . 'k' }}
                                    </div>
                                    <div class="text-muted"
                                        style="font-size: 9.5px; text-transform: uppercase; letter-spacing: 0.05em;">Top 5
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="mb-2">
                                    <div class="d-flex justify-content-between align-items-center mb-1"
                                        ...
                                        <span class="font-weight-bold text-dark d-flex align-items-center"
                                            style="gap: 6px;">
                                            <span
                                                style="display: inline-block; width: 8px; height: 8px; border-radius: 50%; background: {{ $cs->color }};"></span>
                                            {{ $cs->category }}
                                        </span>
                                        <span class="text-dark font-weight-bold">
                                            {!! formatWithCurrency($cs->total) !!}
                                            <span class="text-muted font-weight-normal ml-1"
                                                style="font-size: 10px;">({{ $cs->percentage }}%)</span>
                                        </span>
                                    </div>
                                    <div class="progress"
                                        style="height: 4px; border-radius: 9999px; background: #f1f5f9;">
                                        <div class="progress-bar"
                                            style="width: {{ $cs->percentage }}%; background: {{ $cs->color }}; border-radius: 9999px;">
                                        </div>
                                    </div>
                                </div>
                            @endforeach
            ...
            <div class="col-lg-6 col-12 mb-4 mb-lg-0">
                <div class="card h-100 border-0 shadow-sm"
                    ...
                    <div class="card-header bg-white d-flex justify-content-between align-items-center py-3 px-4"
                        ...
                        <div class="d-flex align-items-center" style="gap: 8px;">
                            <span class="d-flex align-items-center justify-content-center"
                                style="width: 28px; height: 28px; border-radius: 6px; background: #fef2f2; color: #ef4444;">
                                <svg width="15" height="15" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2.2" stroke-linecap="round"
                                    stroke-linejoin="round">
                                    <polygon
                            ...
                            <div>
                                <h4 class="font-weight-bold text-dark mb-0" style="font-size: 15px;">Best Seller Products
                                </h4>
                                <small class="text-muted">Highest volume items sold across operations</small>
                            </div>
                        </div>
                        <a href="{{ route('admin.reports.best-sellers') }}"
                            class="btn btn-sm btn-outline-danger font-weight-bold py-1 px-3"
                        ...
                        <div class="list-group list-group-flush">
                            @forelse($bestSellerProducts as $index => $product)
                                @php
                                    ...
                                    $imageSrc = !empty($product->image)
                                        ? asset($product->image)
                                        : asset('uploads/no-image.svg');
                                @endphp
                                <div class="list-group-item d-flex align-items-center justify-content-between p-3 border-bottom"
                                    style="transition: all 0.2s ease; gap: 12px; border-color: #f1f5f9 !important;">
                                    {{-- Rank Badge & Product Info --}}
                                    <div class="d-flex align-items-center min-w-0" style="gap: 12px; flex: 1;">
                                        {{-- Rank Badge --}}
                                        <div class="font-weight-bold d-flex align-items-center justify-content-center shadow-none flex-shrink-0"
                                            style="width: 26px; height: 26px; border-radius: 50%; font-size: 11.5px; {{ $rankBg }}">
                                            {{ $rank }}
                                        </div>
                                        ...
                                        <img src="{{ $imageSrc }}"
                                            ...
                                            alt="{{ $product->product_name }}" class="flex-shrink-0"
                                            style="width: 44px; height: 44px; border-radius: 8px; object-fit: contain; background: #f8fafc; border: 1px solid #e2e8f0; padding: 2px;">

                                        {{-- Title & Meta --}}
                                        <div class="min-w-0" style="flex: 1;">
                                            <div class="font-weight-bold text-dark text-truncate"
                                                title="{{ $product->product_name }}"
                                                style="font-size: 13.5px; line-height: 1.3;">
                                                {{ $product->product_name }}
                                            </div>
                                            <div class="d-flex align-items-center flex-wrap mt-1" style="gap: 6px;">
                                                <span class="badge badge-light border text-muted"
                                                    style="font-size: 10px; padding: 1.5px 6px; font-weight: 600;">
                                                    {{ $product->category ?: 'General' }}
                                                </span>
                                                @if (($product->current_stock ?? 0) > 10)
                                                    <span class="badge badge-success font-weight-bold px-2 py-0.5"
                                                        style="font-size: 9.5px; background: #ecfdf5; color: #047857; border: 1px solid #a7f3d0;">
                                                        <i
                                                            class="fas fa-check-circle mr-1"></i>{{ number_format($product->current_stock) }}
                                                        in stock
                                                    </span>
                                                @else
                                                    <span class="badge badge-danger font-weight-bold px-2 py-0.5"
                                                        style="font-size: 9.5px; background: #fee2e2; color: #b91c1c; border: 1px solid #fca5a5;">
                                                        <i class="fas fa-exclamation-circle mr-1"></i>Only
                                                        {{ number_format($product->current_stock ?? 0) }} left
                                                    </span>
                                                @endif
                                            </div>
                                        </div>
            ...
            <div class="col-lg-6 col-12">
                <div class="card h-100 border-0 shadow-sm"
                    ...
                    <div class="card-header bg-white d-flex justify-content-between align-items-center py-3 px-4"
                        ...
                        <div class="d-flex align-items-center" style="gap: 8px;">
                            <span class="d-flex align-items-center justify-content-center"
                                style="width: 28px; height: 28px; border-radius: 6px; background: #fffbeb; color: #d97706;">
                                <svg width="15" height="15" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2.2" stroke-linecap="round"
                                    stroke-linejoin="round">
                        ...
                        <a href="{{ route('admin.reports.top-customers') }}"
                            class="btn btn-sm btn-outline-warning font-weight-bold py-1 px-3"
                            style="border-radius: 20px; font-size: 11px;">
                            View All
                        </a>
                    </div>
                        ...
                        <div class="list-group list-group-flush">
                            @forelse($topCustomers as $index => $customer)
                                @php
                                    $rank = $index + 1;
                                    $displayName =
                                        optional($customer->user)->outlet_name ?:
                                        optional($customer->user)->name ?? 'Client #' . $customer->user_id;
                                    $initials =
                                        strtoupper(substr(preg_replace('/[^a-zA-Z]/', '', $displayName), 0, 2)) ?: 'CL';
                                ...
                                <div class="list-group-item d-flex align-items-center justify-content-between p-3 border-bottom"
                                    ...
                                    <div class="d-flex align-items-center min-w-0" style="gap: 12px; flex: 1;">
                                        {{-- Rank Number --}}
                                        <div class="font-weight-bold text-muted flex-shrink-0"
                                            style="width: 20px; font-size: 12.5px;">
                                            #{{ $rank }}
                                        </div>

                                        {{-- Customer Initials Avatar --}}
                                        <div class="d-flex align-items-center justify-content-center font-weight-bold text-white flex-shrink-0"
                                            style="width: 42px; height: 42px; border-radius: 10px; background: linear-gradient(135deg, #1e293b 0%, #334155 100%); font-size: 12.5px; letter-spacing: 0.5px; border: 1px solid #cbd5e1;">
                                            {{ $initials }}
                                        </div>
                                        ...
                                        <div class="min-w-0" style="flex: 1;">
                                            <div class="font-weight-bold text-dark text-truncate"
                                                title="{{ $displayName }}" style="font-size: 13.5px; line-height: 1.3;">
                                                <a href="{{ route('admin.reports.orders', ['user_id' => $customer->user_id]) }}"
                                                    class="text-dark hover-primary" style="text-decoration: none;">
                                                    {{ $displayName }}
                                                </a>
                                            </div>
                                            <div class="d-flex align-items-center text-muted small mt-0.5"
                                                style="font-size: 11px; gap: 6px;">
                                                @if (optional($customer->user)->phone)
                                                    <span><i
                                                            class="fas fa-phone mr-1"></i>{{ $customer->user->phone }}</span>
                                                    <span>&bull;</span>
                                                @endif
                                                <span class="badge badge-light border text-muted px-1.5 py-0.5"
                                    ...
                                    <div class="text-right flex-shrink-0 pl-2">
                                        ...
                                        <div class="mt-1">
                                            @if ($hasDue)
                                                <span class="badge font-weight-bold px-2 py-0.5"
                                                    style="font-size: 9.5px; background: #fee2e2; color: #b91c1c; border: 1px solid #fca5a5;">
                    ...
                    <div class="card-header bg-white d-flex justify-content-between align-items-center py-3 px-4"
                        ...
                        <div class="d-flex align-items-center" style="gap: 8px;">
                            ...
                            <div>
                                ...
                                <small class="text-muted">Live commercial sales orders placed across outlets and web
                                    portal</small>
                            </div>
                        </div>
                        <a href="{{ route('admin.orders.index') }}"
                            class="btn btn-sm btn-outline-primary font-weight-bold py-1 px-3"
                            style="border-radius: 20px; font-size: 11px;">
                            View All Orders
                        </a>
                    </div>
                        ...
                        <div class="table-responsive mb-0">
                            <table class="table table-hover mb-0" style="font-size: 13px;">
                                <thead class="bg-light text-muted text-uppercase"
                                    style="font-size: 10.5px; letter-spacing: 0.05em;">
                                    <tr>
                                ...
                                <tbody>
                                    @forelse($recentOrders as $order)
                                        @php
                                            ...
                                            $clientName =
                                                optional($order->user)->outlet_name ?:
                                                optional($order->user)->name ?? 'Walk-in Client';
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if ($isPaid)
                                                    <span class="badge px-2 py-0.5 font-weight-bold"
                                                        style="font-size: 10px; background: #ecfdf5; color: #047857; border: 1px solid #a7f3d0; border-radius: 4px;">
                                                        <i class="fas fa-check-circle mr-1"></i>PAID
                                                    </span>
                                                @elseif($isPartial)
                                                    <span class="badge px-2 py-0.5 font-weight-bold"
                                                        style="font-size: 10px; background: #fffbeb; color: #b45309; border: 1px solid #fde68a; border-radius: 4px;"
                                                        title="Due: {!! formatWithCurrency($dueAmount) !!}">
                                                        PARTIAL
                                                    </span>
                                                @else
                                                    <span class="badge px-2 py-0.5 font-weight-bold"
                                                        style="font-size: 10px; background: #fef2f2; color: #b91c1c; border: 1px solid #fca5a5; border-radius: 4px;">
                                                        DUE
                                                    </span>
                                                @endif
                                            </td>
                                            <td class="text-center">
                                                <span class="badge {{ $statusBadge }} px-2 py-1 font-weight-bold"
                                                    style="font-size: 10.5px; text-transform: uppercase;">
                                                    {{ str_replace('_', ' ', $order->status) }}
                                                </span>
                                            </td>
                                            <td class="text-right pr-4">
                                                <a href="{{ route('admin.orders.show', $order->id) }}"
                                                    class="btn btn-sm btn-light border py-1 px-2 font-weight-bold text-dark"
                                                    style="font-size: 11px; border-radius: 6px;">
                                                    Details
                                                </a>
                                            </td>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="7" class="text-center py-4 text-muted font-italic">No
                                                commercial orders found in this period.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
            ...
            if (revCtx) {
                            ...
                            yAxes: [{
                                ...
                                ticks: {
                                    ...
                                    callback: function(value) {
                                        if (value >= 1000000) return 'kr. ' + (value / 1000000)
                                            .toFixed(1) + 'M';
                                        if (value >= 1000) return 'kr. ' + (value / 1000)
                                            .toFixed(0) + 'k';
                                        return 'kr. ' + value;
                                    }
                                }
                        ...
                        tooltips: {
                            ...
                            callbacks: {
                                label: function(tooltipItem) {
                                    return ' Revenue: kr. ' + Number(tooltipItem.yLabel).toLocaleString(
                                        'da-DK', {
                ...
                window.switchExecutiveChart = function(type) {
                    ...
                    if (type === 'orders') {
                        ...
                        executiveChartInstance.options.scales.yAxes[0].ticks.callback = function(val) {
                            return val + ' orders';
                        };
                        executiveChartInstance.options.tooltips.callbacks.label = function(item) {
                            return ' Volume: ' + item.yLabel + ' orders';
                        };
                    } else {
                        ...
                        executiveChartInstance.options.tooltips.callbacks.label = function(item) {
                            return ' Revenue: kr. ' + Number(item.yLabel).toLocaleString('da-DK', {
                                minimumFractionDigits: 2
                            });
                        };
                    }
