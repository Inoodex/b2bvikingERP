...
@section('title', 'B2B Sales Orders (SO)')

@section('content')
    <section class="section">
        {{-- Standard Stisla Section Header --}}
        <div class="section-header">
            <h1><i class="fas fa-file-invoice text-primary mr-2"></i>B2B Sales Orders (SO)</h1>
            <div class="section-header-button">
                <a href="{{ route('admin.sales-orders.create') }}" class="btn btn-primary"><i class="fas fa-plus mr-1"></i> Create Sales Order</a>
            </div>
                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary mb-4">
                        <div class="card-header">
                            <h4><i class="fas fa-filter mr-2"></i>Filter B2B Sales Orders</h4>
                        </div>
                        <div class="card-body">
