...
@section('title', 'Create Customer Pricelist')
        ...
        <div class="section-header border-0 shadow-sm mb-4" style="background: #ffffff; border-radius: 16px; padding: 20px 24px;">
            <div class="d-flex align-items-center flex-wrap w-100">
                <div class="d-flex align-items-center mb-2 mb-sm-0">
                    ...
                    <div>
                        <h4 class="mb-1 font-weight-bold text-dark" style="font-family: 'Plus Jakarta Sans', sans-serif;">Create Customer Pricelist</h4>
                        <p class="text-muted mb-0 small">Define custom product prices for specific customer segments</p>
                    </div>
                </div>
                            ...
                            <div class="card-body p-4">
                                <div class="row">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="e.g. Wholesale Special Pricing 2026" value="{{ old('name') }}" required style="border-radius: 8px;">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        ...
                                        <select name="customer_segment" class="form-control" required style="border-radius: 8px;">
                                            <option value="wholesale" selected>Wholesale Customer</option>
                                ...
                                <div class="row">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="date" name="valid_from" class="form-control" value="{{ old('valid_from') }}" style="border-radius: 8px;">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label class="font-weight-bold text-dark">Valid To (Optional)</label>
                                        <input type="date" name="valid_to" class="form-control" value="{{ old('valid_to') }}" style="border-radius: 8px;">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label class="font-weight-bold text-dark">Region / Location (Optional)</label>
                                        <input type="text" name="region" class="form-control" placeholder="e.g. Europe / Global" value="{{ old('region') }}" style="border-radius: 8px;">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card card-primary border-0 shadow-sm mb-4" style="border-radius: 16px;">
                                    ...
                                    <table class="table table-hover mb-0" id="pricelistTable">
                                        ...
                                        <tbody id="priceRows">
                                            <tr class="price-row">
                                                ...
                                                <td>
                                                    <input type="number" step="0.01" min="0" name="items[0][price]" class="form-control price-input" placeholder="Enter special price" required style="border-radius: 8px;">
                                                </td>
                            ...
                            <div class="card-footer bg-white border-top text-right p-4">
                                <button type="submit" class="btn btn-success px-5 py-2 font-weight-bold shadow-sm" style="border-radius: 10px;">
                                    <i class="fas fa-save mr-2"></i> Save Pricelist
                                </button>
                            </div>
                        </div>
                    </div>
