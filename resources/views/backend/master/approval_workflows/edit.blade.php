                            ...
                            <div id="steps-container">
                                ...
                                <div class="step-row row align-items-center mb-3 bg-light p-3 rounded">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="steps[{{ $order }}][approver_role_id]" class="form-control">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="steps[{{ $order }}][approver_user_id]" class="form-control">
                                            <option value="">Any user in role</option>
                                            @foreach($users as $user)
                                                <option value="{{ $user->id }}" {{ $step->approver_user_id == $user->id ? 'selected' : '' }}>{{ $user->name }} ({{ $user->email }})</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
