...
class SalesQuotationController extends Controller
{
    ...
    public function destroy(SalesQuotation $salesQuotation): RedirectResponse
    {
        try {
            $salesQuotation->items()->delete();
            $salesQuotation->delete();

            toastr()->success('Sales Quotation deleted successfully!');
        } catch (\Exception $e) {
            toastr()->error('Failed to delete Sales Quotation: ' . $e->getMessage());
        }
